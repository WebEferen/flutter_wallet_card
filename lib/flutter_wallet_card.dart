...
class FlutterWalletCard {
  ...
  /// [metadata] - Optional metadata for the card
  static Future<bool> addFromUrl(String url, {Map<String, dynamic>? metadata}) async {
    try {
  ...
  static WalletCard _convertApplePassToWalletCard(Map<String, dynamic> passJson, File file) {
  ...
  static WalletCard _convertGoogleCardToWalletCard(Map<String, dynamic> cardJson, File file) {
  ...
  static WalletCardType _getCardTypeFromApplePass(Map<String, dynamic> passJson) {
    ...
    if (passJson.containsKey('boardingPass')) return WalletCardType.boardingPass;
